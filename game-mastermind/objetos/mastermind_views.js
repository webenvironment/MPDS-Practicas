...
initMastermindView().start();

function initMastermindView() {
    return {
        continueDialogView: initYesNoDialogView('Quieres jugar de nuevo?'),
        start() {
            do {
                const gameView = initGameView();
                gameView.play()
                this.continueDialogView.read();
            } while (this.continueDialogView.isAffirmative());
        }
    }
}
function initGameView() {
    ...
    return {
        play: function () {
            ...
            do {
                that.show();
                const proposedCombination = initCombinationView().getProposedCombination();
...
function initYesNoDialogView(dialogText) {
    return {
